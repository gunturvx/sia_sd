             ...
             <div class="card shadow mb-4">
                 ...
                 <div class="card-body">
                     ...
                     <div class="card-category">
                         <center>
                             Jl. Banyupanas No. 07, Cipari, Kec. Cipari, Kab. Cilacap, Jawa Tengah, dengan kode pos
                             53262.
                             <br>Email : sdnegericipari02@gmail.com
                         </center>
                     </div>
                 </div>
             </div>
         ...
         <div class="col-xl-4 col-lg-5">
             <div class="card shadow mb-4">
                 ...
                 <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                     <h6 class="m-0 font-weight-bold text-primary">Data SD Negeri Cipari 02</h6>
                 </div>
                 <!-- Card Body -->
                 <div class="card-body">
