    ...
    <div class="col-md-12 col-xs-12 mt-3">
        ...
        <a target="_blank"
            ...
            <div class="alert alert-success alert-dismissible" role="alert">
                <strong>REKAP SEMESTER (<?=strtoupper($d['semester']) ?> -
                    <b><?=strtoupper($d['tahun_ajaran']) ?></b>)</strong>
            </div>
        </a>
        ...
        <a target="_blank"
            href="modul/rekap/rekap_bulan.php?pelajaran=<?=$_GET['pelajaran'] ?>&bulan=<?=$bulan;?>&kelas=<?=$d['id_mkelas'] ?>"
